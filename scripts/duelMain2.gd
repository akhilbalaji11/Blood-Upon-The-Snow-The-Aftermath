...
const MAX_HP := 100
const DMG := 40
const WINDOW := { 0: 1.2, 1: 1.0, 2: 0.7 }   # How long button stays
...
##
	##if duelPlayerHP <= 0:
		...
		##duelClickBtn.disabled = true
##
		### Connect to player animation finished signal and play death
